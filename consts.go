...
var (
	...
	symbols = map[int]Symbol{ // Color options are listed at https://github.com/gdamore/tcell/blob/master/color.go
		...
		KeyTreeTrunk:     {char: ' ', aboveActor: false, style: tcell.StyleDefault.Background(tcell.ColorSaddleBrown)},
		KeyTreeLeaves:    {char: ' ', aboveActor: true, style: tcell.StyleDefault.Background(tcell.ColorForestGreen)},
